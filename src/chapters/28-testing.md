...
num: 28
part: 3
title: تست‌نویسی مدرن
short: تست‌نویسی
subtitle: Vitest، Playwright، TDD
lead: کد بدون تست، بدهی فنی است.
---
...
<div class="flow">
<div class="box"><b>Unit</b>70%</div>
<span class="arrow">→</span>
<div class="box"><b>Integration</b>20%</div>
<span class="arrow">→</span>
<div class="box"><b>E2E</b>10%</div>
</div>

## Vitest

```js title="math.test.js"
...
:::interview
**Mid — تفاوت Unit و Integration؟** Unit یک واحد جدا؛ Integration تعامل چند واحد.
:::

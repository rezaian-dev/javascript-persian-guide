...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://rezaian-dev.github.io/javascript-persian-guide/" },
  icons: { icon: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/js-logo-64.png` },
  manifest: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/manifest.webmanifest`,
  title: "مرجع فارسی JavaScript ES2025 | از مدل ذهنی تا Production",
  description:
    "مرجع فارسی جاوااسکریپت ES2025 در ۳۸ فصل — Scope، Closure، this، Promise، Event Loop، V8، امنیت، تست و معماری. رایگان و متن‌باز.",
  openGraph: {
    ...
    images: [{ url: `${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/social-card.jpg?v=3`, width: 1280, height: 640 }],
    locale: "fa_IR",
    type: "book",
  },
...
const BOOK_JSONLD = {
  ...
  "@type": "Book",
  name: "مرجع فارسی JavaScript ES2025",
  alternateName: "JavaScript Persian Guide",
  inLanguage: "fa",
  numberOfPages: 156,
  bookEdition: "1.0.0",
  ...
  datePublished: "2026",
  url: "https://rezaian-dev.github.io/javascript-persian-guide/",
  image: "https://rezaian-dev.github.io/javascript-persian-guide/social-card.jpg?v=3",
  description:
